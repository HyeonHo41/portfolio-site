...
spyEls.forEach(function (spyEls) {
  //매개변수,인덱스 결과값이 필요하지 않고 반복만 필요하기에 .forEach
...
const navSpan = document.querySelector(".btn-hamburger .material-symbols-outlined");

function updateNavIcon() {
  navSpan.textContent = navEl.classList.contains("active") ? "close" : "menu";
}
...
const delta = 30; // 30px 이상 움직일 때만 반응
